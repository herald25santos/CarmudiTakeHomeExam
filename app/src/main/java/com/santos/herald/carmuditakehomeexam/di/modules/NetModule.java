...
import com.santos.herald.carmuditakehomeexam.BuildConfig;
import com.santos.herald.carmuditakehomeexam.network.ApiServices;
import com.santos.herald.carmuditakehomeexam.network.exception.RxErrorHandlingCallAdapterFactory;
...
public class NetModule {
    ...
    ApiServices provideApiServices(Application application) {
        return provideRetrofit(provideOkHttpClient(), provideGsonConverterFactory(), provideRxJavaCallAdapterFactory()).create(ApiServices.class);
    }
